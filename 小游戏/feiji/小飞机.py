...
class Bullet:
    def __init__(self):
        self.screen_height, self.screen_width = (667, 375)
...
backgroundMusic = pygame.mixer.Sound("background.wav")
backgroundMusic.play()
boom = pygame.mixer.Sound("boom.wav")
boom.set_volume(0.4)
planeBoom = pygame.mixer.Sound("planeboom.wav")
planeBoom.set_volume(0.2)
screen = pygame.display.set_mode((375,667), 0, 32)
pygame.display.set_caption("空中历险记")
